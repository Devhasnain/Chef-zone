                ...
                <View>
                    ...
                    >
                        {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                            <View>
                                <Input placeholder="First name" value={values.firstName} onChange={handleChange('firstName')} error={touched.firstName && errors.firstName} />
                                <Input placeholder="Last name" value={values.lastName} onChange={handleChange('lastName')} error={touched.lastName && errors.lastName} />
                                <Input placeholder="Date of birth" value={values.dateOfBirth} onChange={handleChange('dateOfBirth')} error={touched.dateOfBirth && errors.dateOfBirth} />
                                ...
                                <Input placeholder="National Insurance No" value={values.nationalInsurance} onChange={handleChange('nationalInsurance')} error={touched.nationalInsurance && errors.nationalInsurance} />
                                <Input placeholder="Mobile number" value={values.mobileNumber} onChange={handleChange('mobileNumber')} error={touched.mobileNumber && errors.mobileNumber} />
