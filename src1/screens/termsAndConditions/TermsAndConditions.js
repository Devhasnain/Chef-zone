  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView ref={scrollRef} showsVerticalScrollIndicator={false} contentContainerStyle={styles.contentContainer}>
        ...
        <SectionContent content='1.1 In these Terms -' />

        <SectionHeader title='“Alternative Hire Period”' />
        <SectionContent content='means as per schedule 1.' />

        <SectionHeader title='“The Assignment”' />
        <SectionContent content='means the period during which The Temp supplied by The Employment Business renders the Services.' />
